...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtCustomerName" runat="server" style="z-index: 1; left: 184px; top: 70px; position: absolute; bottom: 473px" height="22px"></asp:TextBox>
        <asp:TextBox ID="txtCustomerContactNo" runat="server" style="z-index: 1; left: 184px; top: 108px; position: absolute" height="22px"></asp:TextBox>
        <asp:TextBox ID="txtDeliveryAddr" runat="server" style="z-index: 1; left: 184px; top: 141px; position: absolute" height="22px"></asp:TextBox>
        <asp:TextBox ID="txtCustomerDob" runat="server" OnTextChanged="TextBox1_TextChanged" style="z-index: 1; left: 184px; top: 177px; position: absolute" height="22px"></asp:TextBox>
        ...
        <asp:Button ID="btnOK" runat="server" height="26px" OnClick="btnOK_Click" style="z-index: 1; left: 10px; top: 277px; position: absolute; right: 1509px; width: 35px;" Text="OK" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 51px; top: 277px; position: absolute; width: 75px;" Text="Cancel" height="26px" />
    </form>
</body>
</html>
